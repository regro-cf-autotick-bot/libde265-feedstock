...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libde265-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libde265-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `libde265` available on your platform:
...
```
pixi search libde265 --channel conda-forge
```
